    ...
    var body: some View {
        NavigationStack {
            List {
                HouseView(
                    houseName: "Ross",
                    houseInformation: "Opened in October 2022,Ross House is named in honor of the Ross Family For their significant contributions to LCS. This house is part of a modern double residence designed to foster a sense of community on campus."
                )
                HouseView(
                    houseName: "Parent",
